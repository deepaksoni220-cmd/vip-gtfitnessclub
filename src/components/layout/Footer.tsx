      ...
      <div className="container mx-auto px-4 md:px-6">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex gap-3 text-muted-foreground">
                ...
                <span>1st Floor, Gurukrupa Complex, Modern Engineering College Rd, off Fergusson College Road, Shivajinagar, Pune 411005</span>
              </li>
              <li className="flex items-center gap-3 text-muted-foreground">
                <Phone className="shrink-0 text-primary" size={20} />
                <span>+91 86001 50150</span>
              </li>
              <li className="flex items-center gap-3 text-muted-foreground">
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} GT Fitness Club. All rights reserved.
          </p>
