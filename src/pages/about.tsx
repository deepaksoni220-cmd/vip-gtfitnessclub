...
export default function About() {
  ...
  return (
    <div ref={containerRef} className="pt-24 pb-12">
      <Helmet>
        <title>About Us | GT Fitness Club</title>
      ...
      <section className="py-20 text-center container mx-auto px-4 about-header">
        ...
        <p className="text-xl md:text-2xl max-w-3xl mx-auto text-muted-foreground font-medium">
          Born from a passion for true fitness, GT Fitness Club is more than a gym. It's a community forged in sweat and dedication.
        </p>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="w-full lg:w-1/2 space-y-8">
              ...
              <p className="reveal-item text-lg text-muted-foreground leading-relaxed">
                GT Fitness Club was built to be that place. A gritty, authentic, high-energy hub where egos are left at the door and hard work is the only currency that matters.
              </p>
