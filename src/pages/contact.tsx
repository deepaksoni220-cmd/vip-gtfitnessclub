...
export default function Contact() {
  ...
  return (
    <div ref={containerRef} className="pt-24 pb-0">
      <Helmet>
        <title>Contact Us | GT Fitness Club</title>
        <meta name="description" content="Get in touch with GT Fitness Club in Shivajinagar, Pune. Start your fitness journey today." />
        <script type="application/ld+json">
          {`
            {
              "@context": "https://schema.org",
              "@type": "HealthAndBeautyBusiness",
              "name": "GT Fitness Club",
              "address": {
                "@type": "PostalAddress",
                "streetAddress": "1st Floor, Gurukrupa Complex, Modern Engineering College Rd, off Fergusson College Road",
                "addressLocality": "Shivajinagar, Pune",
                "addressRegion": "Maharashtra",
                "postalCode": "411005",
                "addressCountry": "IN"
              },
              "telephone": "+91 86001 50150",
              "aggregateRating": {
          ...
          <div className="space-y-12">
              ...
              <div className="space-y-8">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg">1st Floor, Gurukrupa Complex,<br/>Modern Engineering College Rd, off Fergusson College Road,<br/>Shivajinagar, Pune, Maharashtra 411005</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-display">+91 86001 50150</p>
                  </div>
                </div>
            ...
            <div className="contact-box bg-card border border-border p-6 flex items-center gap-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">Based on 175+ reviews from our members in Shivajinagar, Pune.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full h-[500px] border-t border-border bg-secondary relative">
        <iframe 
          src="https://maps.google.com/maps?q=Gurukrupa+Complex+Modern+Engineering+College+Road+Shivajinagar+Pune+Maharashtra+411005&output=embed" 
          width="100%" 
          height="100%" 
          ...
          title="GT Fitness Club Location Map"
        ></iframe>
      </div>
    </div>
  );
