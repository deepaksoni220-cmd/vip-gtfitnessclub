...
export default function Home() {
  ...
  return (
    <div ref={containerRef}>
      <Helmet>
        <title>GT Fitness Club | Premium Gym in Pune</title>
      ...
      <section className="py-24 bg-background reveal-section">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { name: "Rahul S.", text: "Best gym in Shivajinagar. The trainers are highly professional and the energy here is unmatched. It's not just a gym, it's a community." },
      ...
      <section className="py-24 bg-primary text-primary-foreground reveal-section">
        <div className="container mx-auto px-4 text-center">
          <h2 className="reveal-item text-4xl md:text-6xl font-black font-display uppercase tracking-tighter mb-6">Join GT Fitness Club Today</h2>
          ...
          <div className="reveal-item flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="xl" variant="outline" asChild className="border-primary-foreground/30 hover:bg-primary-foreground hover:text-primary rounded-none font-bold uppercase tracking-wider px-8 py-6 text-lg">
              <a href="tel:918600150150">Call +91 86001 50150</a>
            </Button>
          </div>
        </div>
      </section>
